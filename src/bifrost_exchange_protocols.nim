...
when dacAdaptiveBuilt:
  ...
  ## it encodes. -d:bifrostDac=off removes it and makes reaching for it a
  ## compile error. It does NOT drop the Eir dependency: AME compresses its
  ## payloads with Eir's RLE whatever DAC does.
  import ./protocols/dac/level1/ack_policy as dac_ack_policy
  import ./protocols/dac/level1/scramble as dac_scramble
  ...
  import ./protocols/dac/level3/link as dac_link
  import ./protocols/dac/level3/link_table as dac_link_table
